...
--
-- Host: 127.0.0.1:3307
-- Generation Time: Oct 23, 2019 at 09:23 AM
...
(26, '231019000001', 'BR000043', 'Saklar Engkel Omi KK', 'PCS', 4500, 10000, 1, 0, 10000);
...
('231019000001', '2019-10-23 06:54:50', 10000, 50000, 40000, 1, 'eceran'),
...
CREATE TABLE `tbl_toko` (
  ...
  `toko_nama` varchar(50) DEFAULT NULL,
  `toko_alamat` varchar(100) DEFAULT NULL,
  `toko_nohp` varchar(25) DEFAULT NULL,
  `toko_kota` varchar(50) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
INSERT INTO `tbl_toko` (`toko_id`, `toko_nama`, `toko_alamat`, `toko_nohp`, `toko_kota`) VALUES
(1, 'Toko Berkah Jaya', 'Ruko Lingkar Timur', '081351511241', 'Sidoarjo');
...
(1, 'Berkah Jaya', 'admin', '21232f297a57a5a743894a0e4a801fc3', '1', '1'),
(2, 'fikri', 'kasir', 'c7911af3adbd12a035b289556d96470a', '2', '1');
